...
class ASDL2021DequeTest {
    ...
    final void testASDL2021Deque() {
        ASDL2021Deque<String> dq = new ASDL2021Deque<String>();
    ...
    final void testAddAll() {
        ...
        paperi.add("Quo");
        dq.addAll(paperi);
        ASDL2021Deque<String> dq1 = new ASDL2021Deque<String>();
        dq1.add("Pluto");
        dq1.add("Paperino");
        dq1.add("Pippo");
        dq1.add("Paperone");
    ...
    final void testAddFirst() {
        ASDL2021Deque<String> d = new ASDL2021Deque<String>();
        ...
        d.addFirst("Minnie");
        ASDL2021Deque.Node<String> first = d.getFirstNode();
    ...
    final void testAddLast() {
        ...
        d.addLast("Pluto");
        ASDL2021Deque.Node<String> first = d.getFirstNode();
        ASDL2021Deque.Node<String> last = d.getLastNode();
